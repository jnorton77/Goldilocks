class HomeController < ApplicationController
  ...
  def yesterday
  	@all_responses = Response.where(created_at: (Time.now.to_datetime - 2.day..Time.now.to_datetime - 1.day)).count == 0 ? 1 : Response.where(created_at: (Time.now.to_datetime - 2.day..Time.now.to_datetime - 1.day)).count
  ...
  def this_week
  	@all_responses = Response.where(created_at: (Date.yesterday-7.day..Time.now.to_datetime)).count == 0 ? 1 : Response.where(created_at: (Date.yesterday-7.day..Time.now.to_datetime)).count
